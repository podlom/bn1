        ...
        switch ($this->lang) {
            case 'en':
                $banners = [
                    ...
                    '<a href="//go.shkodenko.com.ua/to/pmp" target="_blank">PHP Mentorship program</a>',
            ...
            case 'uk':
                $banners = [
                    ...
                    '<a href="//go.shkodenko.com.ua/to/4" target="_blank" class="p-2 rounded-lg">Пригостіть мене горнятком кави ☕</a>',
                    ...
                    '<a href="//go.shkodenko.com.ua/to/3" target="_blank" class="p-2 rounded-lg">Підтримайте мене на Patreon ☕</a>',
                    ...
                    '<a href="//go.shkodenko.com.ua/to/pmp" target="_blank">Менторська програма PHP</a>',
            ...
            default:
                $banners = [
                    ...
                    '<a href="//go.shkodenko.com.ua/to/pmp" target="_blank">Менторская программа PHP</a>',
